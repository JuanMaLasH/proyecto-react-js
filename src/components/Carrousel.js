    ...
    return (
        <div id='carouselHome' className='carousel slide' data-bs-ride='true'>
            ...
            <div className='carousel-inner'>
              ...
              <div className='carousel-item'>
                <img src={foto3} className='d-block w-100' alt='Banner de la tienda'/>
              </div>
              <div className='carousel-item'>
                <img src={foto4} className='d-block w-100' alt='Banner de la tienda'/>
              </div>
              <div className='carousel-item'>
                <img src={foto5} className='d-block w-100' alt='Banner de la tienda'/>
              </div>
            </div>
